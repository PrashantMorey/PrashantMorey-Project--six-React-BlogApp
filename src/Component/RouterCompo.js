...
function RouterCompo() {
  const [data,setData] = useState ([
    ...
    },
    {
        ...
        catu: "TopPostt",
        cat : "url",
        urlImg : "https://53.fs1.hubspotusercontent-na1.net/hub/53/hubfs/Headline-Examples.jpg?width=893&height=600&name=Headline-Examples.jpg",
        title : "13 Types of Blog Headlines That'll Get You More Traffic [+ Examples]",
        content : "Fewer people read your blog posts than you think. More people read your headline than you think, too.",
        discription : "You might not realize it, but your headline could be the reason you're losing traffic. In fact, on average, only 20% of those who read your headline will click through to read your article. That means good headlines lose 80% of your audience.Great headlines, though, can make a dramatic impact in the opposite direction. You can increase the traffic to your articles by as much as 500%, based solely on the headline.Not only does the headline affect click-through rates of your blog, but it sets the tone and establishes the key subject of the article. Turns out, a title can have a huge impact on what the audience takes away from an article.",
    },
    {
        id : 64,
        catu: "TopPost",
    ...
    },
    {
        ...
        catu: "TopPost",
        cat : "url",
        urlImg : "https://boyo.l8t.top/wp-content/uploads/2020/04/sweet_as_honey.jpg",
        title : "Sweet as Honey",
        content : "The name of this food blog fits perfectly with its content promoting low-carbon baking without refined sugar and simple carbohydrates.",
        discription : "The name of this food blog fits perfectly with its content promoting low-carbon baking without refined sugar and simple carbohydrates. The author of Sweet as Honey is Carine Claudepierre, a low-carbohydrate baker, food photographer, and filmmaker :). Carine wants to make low-carbon baking simple for everyone and tasty, at the same time. Thanks to its recipes, it encourages everyone to change their lifestyle, change their diet, without losing their taste. You can eat healthy and delicious at the same time.",
    },
    {
        id : 66,
        catu: "TopPost",
        cat : "url",
        urlImg : "https://images.moneycontrol.com/static-mcnews/2023/08/ezgif.com-gif-maker-13-1-770x433.jpg?impolicy=website&width=770&height=431",
        title : "Mission: Impossible | Tom Cruise and Ethan Hunt — Are they the same person?",
        content : "The grammatically challenged franchise has always been defined by its producer and star Tom Cruise, but the last few instalments have blurred the line between the actor and the character.",
        discription : "Late in Mission: Impossible — Rogue Nation (2015), Alec Baldwin’s CIA director Hunley describes IMF agent Ethan Hunt as “the living manifestation of destiny”. It’s a descriptor that seems like it was lifted off a magazine profile of star Tom Cruise himself. You wouldn’t know it by looking at him, but his career in Tinseltown is now into its fifth decade. Cruise has played many iconic and diverse characters over the years, but his enduring legacy is going to be Mission: Impossible’s Ethan Hunt, the quintessential embodiment of his on-screen persona.Actors and characters bleeding into one another is not a unique phenomenon. Screenwriters usually write (and rewrite) to their stars’ strengths, playing off their public-facing personas. It’s most visible in long-running franchises, where the star, the creative team, and the audience have had the opportunity to live with a character for multiple outings. John Wick may have started off as a stereotypical assassin, but over the course of four movies has so thoroughly settled into the laconic style of star Keanu Reeves that it seems like a fantasy extension of Reeves himself.",
    },
    {
        id : 67,
        catu: "TopSiren",
        cat : "url",
        urlImg : "https://www.hindustantimes.com/ht-img/img/2023/08/13/550x309/photo_2023-08-13_17-49-43_1691929608390_1691929851062.jpg",
        title : "Keerthy Suresh radiates beauty in a stunning sky blue blazer set. It costs ₹78k",
        content : "Keerthy Suresh exudes elegance as she gets decked up in a gorgeous sky blue blazer set adorned with floral embellishments, showcasing her fashion finesse.",
        discription : "Ranveer Singh's Top 10 Opening Weekend Grosser Ranveer Singh TOP 10 Movies Opening Weekend Collection: Ranveer Singh and Alia Bhatt lead role film 'Rocky Aur Rani Ki Prem Kahani' has rocked the box office. The film has collected more than 40 crores at the box office in the first 3 days. With this, 'Rocky and Rani Ki Prem Kahani' has joined the list of Ranveer Singh's highest-grossing films on the opening weekend. So let's know what is the number of 'Rocky and Rani's love story' in this list.",
    },
    {
        id : 68,
        catu: "TopSiren",
        cat : "url",
        urlImg : "https://sloanreview.mit.edu/wp-content/uploads/2022/07/GEN-MostPopular2022-1290x860REV-1.jpg",
        title : "The 10 Most Popular Articles in 2022 (So Far)",
        content : "Year three of a global pandemic. A war in Ukraine. Inflation in the U.S. at a 40-year high. Small talk around the watercooler (mainly the virtual one, nowadays) certainly feels heavier than it used to.",
        discription : "Recent Gallup data indicates that in 2022, companies and managers remain challenged by the task of raising employee engagement to pre-pandemic levels. Nearly half of global workers (44%) surveyed reported feeling “a lot” of stress in the previous day. The Great Resignation has demonstrated the power of employees to vote with their feet, and a resurgence of the labor movement in the U.S. has put pressure on even top-tier companies to improve working conditions.Recent Gallup data indicates that in 2022, companies and managers remain challenged by the task of raising employee engagement to pre-pandemic levels. Nearly half of global workers (44%) surveyed reported feeling “a lot” of stress in the previous day. The Great Resignation has demonstrated the power of employees to vote with their feet, and a resurgence of the labor movement in the U.S. has put pressure on even top-tier companies to improve working conditions.To begin to fix these issues, managers must focus on two areas in particular: leadership and culture. In the first months of the year, many MIT SMR readers turned their attention to articles focused on workplace culture, talent management, and employee retention.",
    },
    {
        id : 69,
        catu: "TopSiren",
        cat : "url",
        urlImg : "https://primexnewsnetwork.com/wp-content/uploads/2023/05/1-37.jpg",
        title : "Top 30 Women Entrepreneurs of The Year 2023 by The Indian Alert",
        content : "New Delhi (India), May 16: Women are making significant progress, challenging norms, and driving innovation in the dynamic field of entrepreneurship. Presented by The Indian Alert and Powered by Digisharks Communications Pvt. Ltd . The list of The Top 30 Women Entrepreneurs of The Year 2023 is proudly presented. These Women are reshaping industries, bringing about job creation, and inspiring future generations.",
        discription : "Women entrepreneurs have demonstrated their ability to excel across various sectors, from technology and finance to fashion and social enterprises. They have launched startups, founded companies, and scale businesses, contributing significantly to economic growth and job creation.The spirit of innovation, perseverance, and determination are exemplified by these remarkable Women entrepreneurs. Through their visionary initiative and innovative ability, they are driving financial development, changing ventures, and making ready for a more promising time to come. The Indian Alert and Digishaks Communications Pvt. Ltd is proud to recognize its outstanding contributions and celebrate their inspiring path to success. As these women business people keep on succeeding, they act as good examples for trying business people, empowering them to seek after their fantasies and have an enduring effect on society.",
    },
    {
        id : 70,
        catu: "HomeMenu",
        cat : "url",
        urlImg : "https://www.wallpaperflare.com/static/231/470/376/moon-lake-sky-night-wallpaper-preview.jpg",
        title : "A full moon is shining over a mountain lake",
        content : "Earth has just one moon – a rocky, cratered place, roughly a quarter the size of Earth and an average of 238,855 miles away",
        discription : "Ranveer Singh's Top 10 Opening Weekend Grosser Ranveer Singh TOP 10 Movies Opening Weekend Collection: Ranveer Singh and Alia Bhatt lead role film 'Rocky Aur Rani Ki Prem Kahani' has rocked the box office. The film has collected more than 40 crores at the box office in the first 3 days. With this, 'Rocky and Rani Ki Prem Kahani' has joined the list of Ranveer Singh's highest-grossing films on the opening weekend. So let's know what is the number of 'Rocky and Rani's love story' in this list.",
    },
    {
        id : 71,
        catu: "HomeMenu",
        cat : "url",
        urlImg : "https://media.gettyimages.com/id/85757595/photo/spiral-galaxy.jpg?s=612x612&w=0&k=20&c=mGz53GAJ6RNH2B3cbh8TMRxKyBqu88kKGFyAk0bQnSk=",
        title : "The Milky Way",
        content : "The idea that each star is a sun, many with their own solar systems, is a powerful reminder of the immense scale of the cosmos. However, the distances to stars in our galaxy are tiny in comparison to distances to other galaxies.",
        discription : "The idea that each star is a sun, many with their own solar systems, is a powerful reminder of the immense scale of the cosmos. However, the distances to stars in our galaxy are tiny in comparison to distances to other galaxies. Since antiquity, observers have noted the existence of nebulous stars; diffuse smudgy or cloudy looking stars. Some of them turned out to be what we now know as nebulae, the places where stars form. Many turned out to be something else entirely. It wasn't until the 1920s when it was confirmed that many of these nebulous stars were in fact completely different galaxies, whole other sets of billions of stars like the Milky Way, far beyond our own.",
    },
    {
        id : 72,
        catu: "HomeMenu",
        cat : "url",
        urlImg : "https://static.vecteezy.com/system/resources/previews/006/660/372/original/glowing-butterflies-flying-above-the-lawn-there-is-a-glow-in-the-dark-in-a-fantasy-theme-butterflies-fly-in-the-dark-on-the-field-3d-rendering-free-photo.jpg",
        title : "Butterfly glow",
        content : "RARKPK made a successful entry in the list of Ranveer Singh's top opening weekend films, the movie got this position",
        discription : "Certain butterfly compound eyes exhibit a brilliantly colored glow from a few facets of the main pseudopupil when examined with white light coming from the same direction as the angle of observation. The glow is usually arranged in a striped pattern with the shorter wavelengths emanating from the dorsal parts of the eye and the longer wavelengths from the ventral parts of the eye. The glow originates in a fusiform filter about 2 by 8 μ that is located just proximal to the rhabdom. The filter consists of about 40 cytoplasmic plates alternating with air spaces that function as an interference filter. These filters function to tint the light passing through the rhabdom. We believe they serve a contrast filtering function for vision.",
    },
    {
        id : 73,
        cat : "url",
  ...
  return (
    <div>
      ...
      <MenuLinks/>
      <Routes>
        <Route path='/' element={<context.Provider value={[data]}><Home/></context.Provider> } />
        <Route path='/bollywood' element={<context.Provider value={[data]}><Bollywood/></context.Provider>} />
        <Route path='/technology' element={<context.Provider value={[data]}><Technology/></context.Provider>} />
        <Route path='/hollywood' element={<context.Provider value={[data]}><Hollywood/></context.Provider>} />
        <Route path='/fitness' element={<context.Provider value={[data]}><Fitness/></context.Provider>} />
        <Route path='/food' element={<context.Provider value={[data]}><Food/></context.Provider>} />
        <Route path='/postpage' element={<context.Provider value={[data]}><Postpage/></context.Provider>} />
      </Routes>
      </BrowserRouter>
    </div>
  )
